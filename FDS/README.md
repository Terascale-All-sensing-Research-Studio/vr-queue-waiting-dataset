...
The standard Frustration Discomfort Scale (FDS) was administered at the [start](https://github.com/Terascale-All-sensing-Research-Studio/vr-queue-waiting-dataset/blob/main/FDS/pre_fds.csv) and [end](https://github.com/Terascale-All-sensing-Research-Studio/vr-queue-waiting-dataset/blob/main/FDS/post_fds.csv) of the study [[1]](#1). The FDS asks participants to rate their frustration and discomfort through the following questions:
